...
local Package = {
	...
	Theme = {
		windows = {
			primaryColor = Color3.fromRGB(30, 34, 40),
			secondaryColor = Color3.fromRGB(30, 34, 40),
		...
		sections = {
			primaryColor = Color3.fromRGB(43, 48, 56),
			titleColor = Color3.fromRGB(255, 255, 255)
		},
		lines = {
		...
		dropdowns = {
			primaryColor = Color3.fromRGB(65, 73, 85),
			secondaryColor = Color3.fromRGB(43, 48, 56),
			focusColor = Color3.fromRGB(255, 193, 37),
			textColor = Color3.fromRGB(255, 255, 255),
		...
		checkboxes = {
			primaryColor = Color3.fromRGB(43, 48, 56),
			secondaryColor = Color3.fromRGB(65, 73, 85),
			focusColor = Color3.fromRGB(255, 193, 37)
		},
		tabs = {
			primaryColor = Color3.fromRGB(255, 193, 37),
...
Package.Elements = {
	...
	},
	{
		...
		onCreate = function(self, elementSettings)
			...
			Background.BackgroundColor3 = (_G.atOm.theme.sections.primaryColor or Color3.fromRGB(255, 255, 255))
			Background.Position = UDim2.new(0, 5, 0, 5)
			Background.Size = UDim2.new(0, 220, 0, 122)
			...
			Content.Size = UDim2.new(0, 100, 0, 153)
			...
			updateSection = function()
				...
				Content.Size = UDim2.new(0, ContentSize.X, 0, ContentSize.Y)
				local newSizeX = UIListLayout.AbsoluteContentSize.X + 30
				...
				if Section.Parent and Section.Parent.Parent then
					local Parent
					if Section.Parent.Parent:IsA("ScrollingFrame") then
						Parent = Section.Parent.Parent
					end
					if Section.Parent:IsA("ScrollingFrame") then
						Parent = Section.Parent
					end
					if Parent.AbsoluteWindowSize.X - 30 > ContentSize.X then
						newSizeX = Parent.AbsoluteWindowSize.X
					end
					if detectChange == false then
						detectChange = true
						Parent.Changed:Connect(function(Prop)
							if Prop == "AbsoluteWindowSize" then
								updateSection()
							end
						end)
					end
				end
				Section.Size = UDim2.new(0, newSizeX, 0, ContentSize.Y + 40)
				Background.Size = UDim2.new(0, newSizeX - 10, 0, ContentSize.Y + 30)	
			end
	...
	},
	{
		...
		onCreate = function(self, elementSettings)
			...
			Border.BackgroundColor3 = (_G.atOm.theme.checkboxes.secondaryColor or Color3.fromRGB(38, 38, 38))
			...
			Background.BackgroundColor3 = (_G.atOm.theme.checkboxes.primaryColor or Color3.fromRGB(23, 23, 23))
			...
			ImageLabel.ImageColor3 = (_G.atOm.theme.checkboxes.primaryColor or Color3.fromRGB(23, 23, 23))
				...
				_G.atOm:createElement(
					{
						...
						userSettings = {
							...
							{
								Property = "focusColor",
								Value = (_G.atOm.theme.checkboxes.focusColor or Color3.fromRGB(255, 193, 37)),
								onChange = function(newValue)
								if element.Value == true then
									Background.BackgroundColor3 = newValue
									Border.BackgroundColor3 = newValue
	...
	},
	{
		...
		onCreate = function(self, elementSettings)
			...
			Top.Name = "Top"
			Top.Parent = Tabs
			Top.BackgroundColor3 = (_G.atOm.theme.tabs.secondaryColor or Color3.fromRGB(38, 38, 38))
	...
	},
	{
		...
		onCreate = function(self, elementSettings)
			...
			Content.BackgroundColor3 = (_G.atOm.theme.windows.primaryColor or Color3.fromRGB(23, 23, 23))
			...
			Top.Name = "Top"
			Top.Parent = Window
			Top.BackgroundColor3 = (_G.atOm.theme.windows.secondaryColor or Color3.fromRGB(38, 38, 38))
			Top.BorderSizePixel = 0
			...
			TextButton.BackgroundColor3 = (_G.atOm.theme.windows.secondaryColor or Color3.fromRGB(38, 38, 38))
			TextButton.BorderSizePixel = 0
			...
			TextButton_2.BackgroundColor3 = (_G.atOm.theme.windows.secondaryColor or Color3.fromRGB(38, 38, 38))
			...
			Content_1.BackgroundColor3 = (_G.atOm.theme.windows.primaryColor or Color3.fromRGB(23, 23, 23))
				...
				_G.atOm:createElement(
					{
						...
						userSettings = {
							...
							{
								Property = "primaryColor",
								Value = Content.BackgroundColor3,
								Occuring = true,
								onChange = function(newValue)
								Content.BackgroundColor3 = newValue
								Content_1.BackgroundColor3 = newValue
							end
							},
							{
								Property = "secondaryColor",
